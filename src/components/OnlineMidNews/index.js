...
import { getById } from "../../api/getMidNews";
import News from '../../api/Mideast'
...
export class index extends Component {
    ...
    render() {
     ...
     ></a>
                    ...
                    <h4 className="mt-5 ">{neews.bigdesc}</h4>
                    </div>
                    <Download/>
                    <div className="bg-white p-2 mb-4" style={{ boxShadow: '0 1px 5px 0 rgb(165, 165, 165)'}}>
                        <div className="title">
                        <div className=" d-flex" > <span className="title-mark1 mt-1 "></span><p className="pt-1">أخبار ذات صلة </p>  </div> 
                        </div>
                        ...
                        {this.state.new1.map((New)=>{
                                    return(<>
                                        ...
                                        <Link onClick={refreshPage} className="text-dark" style={{textDecoration:'none'}} to={"/Mideast/"+New.id}>
