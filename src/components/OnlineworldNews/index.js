                    ...
                    <div className="bg-white p-2 mb-4" style={{ boxShadow: '0 1px 5px 0 rgb(165, 165, 165)'}}>
                        ...
                        {this.state.new1.map((New)=>{
                                    return(
                                        ...
                                        <Link onClick={refreshPage} className="text-dark" style={{textDecoration:'none'}}  to={"/world-news/"+New.id}>
                                                ...
                                                <div className="col-sm-8 col-md-7 col-sm-12">
