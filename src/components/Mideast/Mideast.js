...
export function Mideast () {
    ...
    const changePage =({selected})=>{
     ...
     const displayNews = news1.slice(pagesVisited, pagesVisited + newsPerPage).map(ne1=>{
        return(
            <div className="flex-lnew mb-3 p-0">
            <Link to={'/Mideast/' + ne1.id} style={{textDecoration:'none'}}>
    ...
    return (<>
         ...
         <div className="row  ">
             ...
             <div className="title " direction="rtl" style={{ boxShadow: '0 1px 5px 0 rgb(165, 165, 165)'}}  >
                  <div className=" d-flex" > <span className="title-mark1 mt-1 "></span><p className="pt-1">شرق أوسط</p>  </div>
                  <div class="d-flex justify-content-around flex-lnews ml-1 " >
                {displayNews}
