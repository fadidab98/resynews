...
export class index extends Component {
    ...
    render() {
          ...
          <div className="container text-right  mt-5 p-0" dir="rtl">
                <div className="row container-fluid m-auto p-0 " >
                    <div className="col-xs-12 col-md-8 col-lg-9">
                        <div className="bg-white p-2" style={{ boxShadow: '0 1px 5px 0 rgb(165, 165, 165)'}}>
                        <h3>{neews.text}</h3>
                        <div className="d-flex   p-0  m-0" ><i class="fa fa-clock-o  fa-clock-o-Break mr-1" aria-hidden="true"></i><p className="m-2 p-0 ">{neews.time}</p></div>
     ...
     ></a>
                    ...
                    <Download/>
                    <div className="bg-white p-2 mb-4" style={{ boxShadow: '0 1px 5px 0 rgb(165, 165, 165)'}}>
                        <div className="title">
                        <div className=" d-flex" > <span className="title-mark1 mt-1 "></span><p className="pt-1">آخبار ذات صلة </p>  </div>   
                        </div>
                        <div className="row mt-1 mb-2 m-0">
                        ...
                        {this.state.new1.map((New)=>{
                                    return(
                                        ...
                                        <Link onClick={refreshPage} className="text-dark" style={{textDecoration:'none'}}  to={"/sport-news/"+New.id}>
                                                <div className="row mt-4" key={New.id}>
                                                    
                                                    <div className="col-lg-4 col-md-5 col-sm-12"><img className="w-100 img-News mb-2" src={New.src} /></div>
                                                
                                                <div className="col-lg-8 col-md-7 col-sm-12 ">
                                                  <div className="border-bottom  "><h5> <span className="title-mark "></span> {New.type} </h5></div>  
                                                    {New.text}
